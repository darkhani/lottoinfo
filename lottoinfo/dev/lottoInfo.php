...
<body>
    <div>
        <div class="align-items-center">
            ...
            <div>
                <!-- <form action=""> -->
                <input type="number" ondrop="return false;" onpaste="return false;" id="searchNum"/>
    ...
    searchButton.addEventListener("click", function() {
        ...
        // 현재 URL을 가져옵니다.
        var currentUrl = "https://www.tegine.com/lottoinfo/dev/lottoinfo_search.php";
