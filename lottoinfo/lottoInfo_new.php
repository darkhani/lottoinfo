...
<body>
    ...
    <form action="#">
        ...
        <input type="number" id="num1" name="num1" min="0"><br><br>

        <label for="num2">숫자 2:</label>
        <input type="number" id="num2" name="num2" min="0"><br><br>

        <label for="num3">숫자 3:</label>
        <input type="number" id="num3" name="num3" min="0"><br><br>

        <label for="num4">숫자 4:</label>
        <input type="number" id="num4" name="num4" min="0"><br><br>

        <label for="num5">숫자 5:</label>
        <input type="number" id="num5" name="num5" min="0"><br><br>

        <label for="num6">숫자 6:</label>
        <input type="number" id="num6" name="num6" min="0"><br><br>
